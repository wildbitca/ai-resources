...
description: >
  ...
  (triggers: **/*.py, django, rest framework, DRF, ViewSet, ModelViewSet, Serializer, ModelSerializer, APIView, urls.py, views.py, serializers.py, permissions.py, FilterSet, django rest)
license: Apache-2.0
metadata:

...
|-----------------|-------------------------|
| `$AGENT_KIT/cursor/workflows/_feature-template.workflow.yaml` | end of **`verify`** (after specs + validation artifact updates) |
| `$AGENT_KIT/cursor/workflows/_bugfix-template.workflow.yaml` | end of **`verify`** |
| `$AGENT_KIT/cursor/workflows/explore-and-plan.workflow.yaml` | end of **`plan`** (after decisions/ + optional research) |
| `$AGENT_KIT/cursor/workflows/release-dart-flutter.workflow.yaml` | end of **`verify`** (after release notes + knowledge artifacts) |
| `$AGENT_KIT/cursor/workflows/cross-domain-backend-infra.workflow.yaml` | end of **`verify`** |
| `$AGENT_KIT/cursor/workflows/security-devsecops.workflow.yaml` | end of **`report`** (after copy to `specs/knowledge/searchable/` if used) |

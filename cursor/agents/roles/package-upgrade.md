...
**Follow the skill pattern:** Read and apply the workflow from the **`package-upgrade-review`** skill in the project's skill library (commonly `$AGENT_KIT/cursor/skills/package-upgrade-review/SKILL.md` or an equivalent path in `AGENTS.md`). Do not skip steps.

...
4. **Skills:** When the plan or project rules name a skill, read and apply that skill from **`$AGENT_KIT/cursor/skills/`** (see **`$AGENT_KIT/cursor/AGENTS.md`**). Examples: dependency install, i18n, migrations—use whatever the plan references for this stack.

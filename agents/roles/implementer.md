...
- Before starting: read `knowledge/research/` for existing analysis relevant to the implementation area
- Before starting: check `knowledge/decisions/` for architectural decisions and plan rationale that guide implementation

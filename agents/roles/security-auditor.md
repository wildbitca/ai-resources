...
- Before starting: check `knowledge/research/` for prior security assessments on this codebase or component
- After audit completion: save the full security report to `knowledge/searchable/`
- Record remediation decisions or accepted risks in `knowledge/decisions/`

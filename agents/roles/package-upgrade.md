...
**Follow the skill pattern:** Read and apply the workflow from the **`package-upgrade-review`** skill (`$AGENT_KIT/skills/package-upgrade-review/SKILL.md`, or lookup via `skills-index.json`). Do not skip steps.

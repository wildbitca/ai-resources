...
2. Run the orchestrator: `.cursor/skills/terraform-maintainer/scripts/maintain.sh /path/to/org-iac` with unbuffered output (e.g. PYTHONUNBUFFERED=1). Use maximum allowed timeout (e.g. 600000 ms) when running in-agent.

...
- Before starting: check `knowledge/research/` for existing research on this topic to avoid redundant exploration
- After producing the plan: save a copy to `knowledge/decisions/` for persistent team reference
...
- When the plan involves architectural choices, check `knowledge/decisions/` for prior ADRs

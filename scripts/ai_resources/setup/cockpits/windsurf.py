"""Windsurf cockpit — writes global_rules.md."""
...
from .. import state
from ..detection import detect_windsurf
...
INSTRUCTIONS_PATH = CONFIG_ROOT / "memories" / "global_rules.md"


def detect():
    return detect_windsurf()
...
def configure(ctx: dict) -> list[Path]:
    ...
    md = _shared.kit_instructions_md("Windsurf", ak_path, gateway_url, s.mode, native_skills=True)

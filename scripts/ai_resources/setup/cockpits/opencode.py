...
from .. import state
from ..detection import detect_opencode
...
def configure(ctx: dict) -> list[Path]:
    ...
    md = _shared.kit_instructions_md("OpenCode", ak_path, gateway_url, s.mode, native_skills=True)
